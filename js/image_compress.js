$(function() {
    ...
    encodeButton.addEventListener('click', function(e) {
        ...
        var source_image = document.getElementById('result_image');
        ...
        var quality = 30;	//parseInt(encodeQuality.value);
    ...
    uploadButton.addEventListener('click', function(e) {
        var result_image = document.getElementById('result_image');
        var imageName = document.getElementById("img_description").value;
        var noJaringan = document.getElementById("no_jar").value;
        document.cookie = 'nojar='+noJaringan ;
        document.cookie = 'deskripsi='+imageName ;
        if (result_image.src == "") {
            alert("Anda harus memilih gambar terlebih dahulu!");
            return false;
        } else {
        ...
        jic.upload(result_image, 'files/dokumentasi/upload.php', 'file', noJaringan+'_'+imageName+'.'+output_format,callback);        
